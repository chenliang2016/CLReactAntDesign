module.exports = app => {
    ...
    app.router.get('/api/menu/list',app.controller.menu.list);
    app.router.get('/api/menu/listByPid',app.controller.menu.listByPid);
    app.router.get('/api/menu/allList',app.controller.menu.allList);
    app.router.post('/api/menu/add',app.controller.menu.add);
    app.router.get('/api/menu/delete',app.controller.menu.delete);
    app.router.post('/api/menu/update', app.controller.menu.update);
};