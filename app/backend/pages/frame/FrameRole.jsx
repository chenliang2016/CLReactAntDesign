...
import {TableModel, Ajax} from '../../../common/Common';
import CLContentCard from '../../../component/CLContentCard';
import CLTree from '../../../component/CLTree';
import CLModalForm from '../../../component/CLModalForm';
        ...
        this.columns = [
            {
                ...
                render: function(text, record, index) {
                    return <div className="table-tools">
                        ...
                        <a onClick={self.configRole(record, index)}>配置权限</a>
                    </div>;
                }
            }
        ];
                ...
                <Row>
                    <Col span="24" style={{backgroundColor:'#f0f0f0' }}>
                        <CLContentCard title="操作" icon="edit" minHeight="20">
                              <Button type="primary" className="button" onClick={this.showForm}>新增</Button>
                        </CLContentCard>
                    </Col>
                </Row>
